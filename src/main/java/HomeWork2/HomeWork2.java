...
public class HomeWork2 {
    public static void main(String[] args) {
        ...
        printString("Hello", 5);
        isMonthColdOrWarm(MyEnums.AUGUST);
        isMonthColdOrWarm(MyEnums.OCTOBER);
        isMonthColdOrWarm(MyEnums.JANUARY);
        isMonthColdOrWarm(MyEnums.MARCH);
    ...
    public static void isMonthColdOrWarm(MyEnums enums){
        switch (enums){
            case DECEMBER:
            case JANUARY:
            case FEBRUARY: {
